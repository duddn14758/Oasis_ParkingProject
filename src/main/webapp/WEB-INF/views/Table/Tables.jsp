...
<!-- MetisMenu CSS -->
<link href="/blog/resources/vendor/metisMenu/metisMenu.min.css"
	rel="stylesheet">

<!-- DataTables CSS -->
<link
	href="/blog/resources/vendor/datatables-plugins/dataTables.bootstrap.css"
	rel="stylesheet">

<!-- DataTables Responsive CSS -->
<link
	href="/blog/resources/vendor/datatables-responsive/dataTables.responsive.css"
	rel="stylesheet">
...
<!-- Custom Fonts -->
<link
	href="/blog/resources/vendor/font-awesome/css/font-awesome.min.css"
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<%@ page import="sun.spring.test.SqlConnection" %>
			<%
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">불법주정차 민원 단속 데이터</div>
						<!-- /.panel-heading -->
							...
							<table width="100%"
								...
								<%for(int i = 0; i<s.size(); i++){ %>
									<tr class="odd gradeX">
										...
										<td><%=s.listday(i)%></td>
										<td ><%=s.listgungu(i)%></td>
										<td class="center"><%=s.listcrackdown(i)%></td>
									</tr>
									<%} %>
	...
	<script
		src="/blog/resources/vendor/datatables/js/jquery.dataTables.min.js"></script>
	<script
		src="/blog/resources/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
	<script
		src="/blog/resources/vendor/datatables-responsive/dataTables.responsive.js"></script>
