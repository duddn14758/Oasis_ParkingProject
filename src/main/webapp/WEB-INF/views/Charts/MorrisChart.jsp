			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"><i class="fa fa-wrench fa-fw"></i> UI
						...
						<ul class="nav nav-second-level">
							<li><a href="/blog/UiElement/PanelsWells">Panels and Wells</a></li>
							<li><a href="/blog/UiElement/Buttons">Buttons</a></li>
							<li><a href="/blog/UiElement/Notifications">Notifications</a></li>
